...
use crate::core::database::{AlgorithmType, BizTagRepository, IdFormat, UpdateBizTagRequest};
    ...
    R: BizTagRepository + Send + Sync,
{
    ...
    pub async fn update_config(
        ...
        let biz_tag = biz_tag_opt.ok_or_else(|| {
            crate::core::CoreError::NotFound(format!(
...
mod tests {
    use super::*;
    use crate::core::database::{BizTag, CreateBizTagRequest, UpdateBizTagRequest};
