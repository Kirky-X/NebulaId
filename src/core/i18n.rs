...
//!   global locale state (Phase 8 ).
//!
//! # Phase 8 — Hidden API Usage
//!
...
/// Phase 8 (perf fix) — zero-allocation translation lookup
...
///
/// Phase 8 (perf fix) — uses `SmallVec` for the keys/values
...
/// Phase 8 (perf fix) — borrow-friendly variant of
